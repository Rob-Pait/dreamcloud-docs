...
conn.add_ip_list(instance_controller_1['id'], [unused_floating_ip['floating_ip_address']])
...
conn.add_ip_list(instance_worker_1['id'], [unused_floating_ip['floating_ip_address']])
